...
def stats(update, context):
    ...
    try:
        update.effective_message.reply_text(status +
            ...
            "\n\n[⍙ GitHub](https://github.com/about-tosuu) | [⍚ GitLab](https://gitlab.com/ITZ-ZAID)\n\n" +
            "╘══「 by [𝘿𝙖𝙢𝙞𝙖𝙣❤‍🩹](https://t.me/its_damiann) 」\n",
        ...
        update.effective_message.reply_text(
            (
                (
                    ...
                    + "\n\n⍙ [GitHub](https://github.com/about-tosu) | ⍚ [GitLab](https://gitlab.com/ITZ-ZAID)\n\n"
                )
                + "╘══「 by [𝘿𝙖𝙢𝙞𝙖𝙣❤‍🩹](https://t.me/its_damiann) 」\n"
            ),
